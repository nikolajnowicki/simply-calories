...
const RegisterModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-LightUiCol dark:bg-DarkUiCol md:dark:bg-black md:dark:bg-opacity-50 md:bg-black md:bg-opacity-50 flex justify-center items-center z-30 md:z-10">
